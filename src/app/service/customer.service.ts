...
export class CustomerService {
  ...
  customers$ = (page: number = 0) => <Observable<CustomHttpResponse<Page<Customer> & User & Stats>>>
    this.httpClient.get<CustomHttpResponse<Page<Customer> & User & Stats>>
  ...
  customer$ = (customerId: number) => <Observable<CustomHttpResponse<CustomerState>>>
    this.httpClient.get<CustomHttpResponse<CustomerState>>
  ...
  update$ = (customer: Customer) => <Observable<CustomHttpResponse<CustomerState>>>
    this.httpClient.put<CustomHttpResponse<CustomerState>>
  ...
  downloadReport$ = () => <Observable<HttpEvent<Blob>>>
    this.httpClient.get(`${this.server}/customer/download/report`, {
      reportProgress: true,
      observe: 'events',
      responseType: 'blob'
    })
